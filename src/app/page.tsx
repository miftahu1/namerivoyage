...
import { 
  ...
  AlertCircle, Megaphone, Send, Map, TreeDeciduous, 
  Waves, Mountain, ChevronRight, Phone, Download
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground scroll-smooth">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <Badge variant="secondary" className="mb-4 px-4 py-1 text-sm font-medium tracking-wide uppercase bg-secondary/20 text-secondary-foreground border-secondary/30">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="rounded-full px-8 bg-primary hover:bg-primary/90 text-lg" asChild>
      ...
      <main className="max-w-7xl mx-auto px-4 py-16 space-y-24">
        ...
        {announcements.length > 0 && (
          <section id="announcements" className="animate-in fade-in duration-700">
        ...
        {/* Trip Details */}
        <section id="details" className="grid lg:grid-cols-3 gap-8">
        ...
        <section id="itinerary">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
             {/* Path line decorative element for desktop */}
                   ...
                   <CardContent className="space-y-4">
                     ...
                     <div className="flex flex-wrap gap-2 pt-2">
                       {day.activities.map((act, i) => (
                         <Badge key={i} variant="secondary" className="bg-secondary/10 text-secondary-foreground border-secondary/20 hover:bg-secondary/20">
                           {act}
                         </Badge>
                       ))}
                     </div>
        ...
        {/* Packing List */}
        <section className="bg-secondary/5 rounded-3xl p-8 md:p-12 border border-secondary/20">
        ...
        <section id="participants">
          <div className="flex items-center justify-between mb-8">
            ...
            <Badge variant="outline" className="text-lg px-4 py-1">{students.filter(s => s.status === 'approved').length} Students</Badge>
          </div>
        ...
        {/* Registration Form */}
        <section id="register" className="max-w-3xl mx-auto scroll-mt-20">
            ...
            <CardContent className="p-8">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="pt-4">
                    <Button type="submit" className="w-full h-12 text-lg font-bold rounded-xl bg-primary hover:bg-primary/90 transition-transform active:scale-95" disabled={isSubmitting}>
        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="space-y-4">
             ...
             <Button variant="link" className="p-0 h-auto text-muted-foreground hover:text-primary" asChild>
               <a href="/admin">Teacher Login Portal</a>
             </Button>
          </div>
        </div>
